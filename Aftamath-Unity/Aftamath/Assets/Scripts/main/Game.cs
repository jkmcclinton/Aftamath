...
public class Game {
	...
	public const short BIT_LAYERSPECIAL = 2;
	public const short BIT_LAYERSPECIAL2 = 4;
	public const short BIT_GROUND = 8;
	public const short BIT_HALFGROUND = 16;
	public const short BIT_BATTLE = 32;
	public const short BIT_LAYER1 = 64;
	public const short BIT_PLAYER_LAYER = 128;
	public const short BIT_LAYER3 = 256;	

	//global constants
	public const float DT = 1/60f;
	public const float PPM = 100f;
	public const float GRAVITY = -9.81f;
	public const float ANIMATION_RATE = .210f;
	public const float ACTION_ANIMATION_RATE = .090f;
	public const float ALPHA = 254/255f;
	public const int FONT_OFFSET = -33;
	public const int OBJ_SCALE = 2;
	public const int LIGHT_RAYS = 150;
	public const int TILE_SIZE = 16;
	public const int TEXT_PERIODX = 6;
	public const int TEXT_PERIODY = -12;

	//light colors
	public const Color DAY_LIGHT = new Color(0, 0, 0, ALPHA);
	public const Color INDOOR_LIGHT = new Color(0, 0, 0, ALPHA);
	public const Color NIGHT_LIGHT = new Color (14/255f, 11/255f, 28/255f, ALPHA);
	public const Color DARK_LIGHT = new Color (1/255f, 1/255f, 1/255f, ALPHA);
	public const Color GHOSTLY_LIGHT = new Color(139/255f, 139/255f, 195/255f, .5f);

	public const Color DAY_OVERLAY = new Color(1, 1, 1, ALPHA);
	public const Color SUNSET_GOLD = new Color(255/255f, 185/255f, 0/255f,ALPHA);
	public const Color SUNSET_ORANGE = new Color(255/255f, 124/255f, 0/255f, ALPHA);
	public const Color SUNSET_MAGENTA = new Color(213/255f, 37/255f, 109/255f, ALPHA);
	public const Color NIGHT_OVERLAY = new Color(44/255f, 48/255f, 107/255f, ALPHA);
	public const Color INDOOR_OVERLAY = new Color(1, 1, 1, ALPHA);
	public const Color DARK_OVERLAY = new Color(32/255f, 25/255f, 74/255f, ALPHA);
	public const Color SUNRISE = new Color(109/255f, 163/255f, 187/255f, ALPHA);
	public const Color FROZEN_OVERLAY = new Color(139/255f, 195/255f, 217/255f, ALPHA/2f);
	public const Color BURN_OVERLAY = new Color(Color.RED);
	...
	public float THUMBSTICK_SENSITIVITY = SENSITIVITY; 

	public const int PLAYER_SCENE_ID = 0;
	public const int NARRATOR_SCENE_ID = 1000;
	public const Array<Color> DEFAULT_COLOR_LIST = new Array<Color>();
	public const Array<String> MALES = new Array<String>(new String[] {"doctordisco","narrator2","gangster1","gangster2","boyfriend1","boyfriend2","boyfriend3","boyfriend4",
	...
	public const HashMap<String, Float> VOICES = new HashMap<>();
	 ...
	 */
	public String remove(String src, String r){
	 ...
	 */
	public int countReg(String s, String regex){
	 ...
	 */
	public TextureRegion[] removeEmptyFrames(TextureRegion[] orig, int length){
	 ...
	 */
	public int PowerOf2(double num){
		//TODO
		return (int) num;
	}
	 ...
	 */
	public String formatDialog(String dialog, boolean hud){
		int max = 20;
		if(hud) max = 50;
		return formatDialog(dialog, max, 4);
	}

	public String formatDialog(String dialog, int w, int h){
	 ...
	 * @return
	 */
	public String formatHundreds(String s, int length){
		switch(length){
		case 1:
			s+="0";
		case 2:
	 ...
	 * @return
	 */
	public String addSpaces(String orig, int length){
		String spaces = "";
	 ...
	 * @return method name
	 */
	public String formatMethodName(String s){
	 ...
	 */
	public String formatDayTime(float time, boolean full){
	 ...
	 */
	public String formatTime(float timeSecs){
	 ...
	 * @see blendColors 
	 */
	public Color blendColors(Color first, Color second){
	 ...
	 */
	public Color blendColors(float t, float start, float end, Color first, Color last){
	 ...
	 * @return
	 */
	public Vector2 getVelocity(Vector2 start, Vector2 target, float magnitude){
	...
	/**
	 * function that eases intorpolation between the initial and const values given a timeframe
	 * @param t the current time in seconds
	 * @param c the const time in seconds
	 * @param d the initial value
	 * @param b the const value
	 * @return the eased interpolation
	 */
	public float easingFunction(float t, float c, float d, float b){
		float a = (float) (-(b-d)/(Math.pow(c,2)));
		return a*(t-c)*(t-c) + b;
	}

	public float b2Cross(Vector2 a, Vector2 b){
		return a.x * b.y - a.y * b.x;
	}

	public Vector2 b2Cross(Vector2 a, float s){
