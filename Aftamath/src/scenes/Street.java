...
public class Street extends Scene {
	...
	public Street(World world, Play play, Player player){
		super(world, null, null, "BGtest", null, "street", play, player, 965, 508);
		DEFAULT_SONG = Gdx.audio.newMusic(new FileHandle("res/music/Explosive.wav"));
		...
		Burly burly = new Burly("The Crusher", 1, 300, 127, Vars.BIT_LAYER3);
		entities.add(burly);
